        ...
        <div class="navbar-header">
            <div class="d-flex align-items-center">
                ...
                <div class="navbar-brand-box mr-3 mr-lg-5">
                    <a href="/" class="logo">
                        <span class="d-none d-lg-block">
                            <img src="../assets/images/logo-dark.png" alt="" height="40" style="margin-top:1px">
                        </span>
                        <i class="d-lg-none">
                            <img src="../assets/images/logo-small.png" alt="" height="40" style="margin-top:1px">
                        </i>
                    </a>
                </div>
                ...
                <div class="header-breadcumb">
                    <h2 class="header-title">{{ this.$route.path.replace("-", " ").split("/").filter(a => a).join(" > ") }}</h2>
                </div>
            </div>
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown d-inline-block ml-2">
                    <button type="button" class="btn header-item" id="page-header-user-dropdown"
                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" @click="() => this.$router.push('/login')">
